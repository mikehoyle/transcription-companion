const PATHS: Record<string, string> = {
  ...
  bug: 'M20 8h-2.81a6 6 0 00-1.82-1.96L17 4.41 15.59 3l-2.17 2.17a5.9 5.9 0 00-2.83 0L8.41 3 7 4.41l1.62 1.63A6 6 0 006.81 8H4v2h2.09A6.6 6.6 0 006 11v1H4v2h2v1c0 .34.04.67.09 1H4v2h2.81a6 6 0 0010.38 0H20v-2h-2.09c.05-.33.09-.66.09-1v-1h2v-2h-2v-1c0-.34-.04-.67-.09-1H20zm-6 8h-4v-2h4zm0-4h-4v-2h4z',
